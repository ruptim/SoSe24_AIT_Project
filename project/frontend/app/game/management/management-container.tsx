...
export function ManagementContainer({buzzers}: ManagementContainerParams) {
    ...
    return (
        <div className={"flex flex-row gap-5 justify-start"}>
            <ConnectBuzzerButton onOpenClicked={connectModalOpened} isPairing={isPairing}
                                 onModalClosed={connectModalClosed} buzzersShown={newBuzzerArr}></ConnectBuzzerButton>
            <EditBuzzersButton buzzers={buzzerArr} onDeleteClick={deleteBuzzer}></EditBuzzersButton>
        </div>
    )
}